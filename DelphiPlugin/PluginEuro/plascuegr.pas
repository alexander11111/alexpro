...
Begin
    ...
    FsgGrid.Cells[7,0]  := 'Период';
    FsgGrid.Cells[8,0]  := 'Пинг';
    FsgGrid.Cells[9,0]  := 'Активность';
    FsgGrid.Cells[10,0] := 'Состояние';
    CloseInfo
End;
...
Begin
    ...
    with pTbl do Begin
     ...
     Begin
      FsgGrid.Cells[10,nY] := ' Включено';
      FsgGrid.AddCheckBox(10,nY, True, false);
     End else
     Begin
      FsgGrid.Cells[10,nY] := ' Выключено';
